                        ...
                        <div class="x-box-mr">
                            <div class="x-box-mc" style="text-align:left">
                                <h3 style="margin-bottom:20px; text-align:left; font-size:11px; color: #006dba;">
                                    请登录<!--<SIAT_zh_CN original="Please login">请登录</SIAT_zh_CN>-->...
                                </h3>
                                    ...
                                    <table style="border:0px; text-align:center; width:100%">
                                        <tr>
                                            <td style="width: 100px">
                                                <label for='j_username' style="font-weight:bold">用户名称<!--<SIAT_zh_CN original="Username">用户名称</SIAT_zh_CN>--> :</label>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <label for='j_password' style="font-weight:bold">密码<!--<SIAT_zh_CN original="Password">密码</SIAT_zh_CN>--> :</label>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <label for='remember_me' style="font-weight:bold">记住我<!--<SIAT_zh_CN original="Remember me">记住我</SIAT_zh_CN>--> :</label>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td colspan=2 style="text-align:center">
                                                <br>
                                                <input type='submit' id='loginButton' value='登录' style="width:100%"/><!--<SIAT_zh_CN original="Login">登录</SIAT_zh_CN>-->
                                                <br>
                                                <br>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" style="font-size:10px;">
                                                尚未注册？请联系<!--<SIAT_zh_CN original="Not a user ? Contact">尚未注册？请联系</SIAT_zh_CN>--> <a
                                                    href="mailto:${grailsApplication.config.com.recomdata.administrator}"
                                                    target="_blank"
                                                    style="text-decoration:underline;color:#0000FF">管理员<!--<SIAT_zh_CN original="administrator">管理员</SIAT_zh_CN>--></a> 申请帐号<!--<SIAT_zh_CN original="to request an account">申请帐号</SIAT_zh_CN>-->
                                            </td>
                                        </tr>
                                        <g:if test='${grailsApplication.config.org.transmart.security.samlEnabled}'>
                                            <tr>
                                                <td colspan="2" style="font-size:10px;">
                                                    <a href="${createLink([action: 'login', controller: 'saml'])}">&gt; 单位登录<!--<SIAT_zh_CN original="Federated Login">单位登录</SIAT_zh_CN>--></a>
                                                </td>
                                            </tr>
                                        </g:if>
                                    </table>
                ...
                <g:if test="${providerName}">
                    <a id="providerpowered" target="_blank"
                       href="${grailsApplication.config?.com?.recomdata?.providerURL}" style="text-decoration: none;">
                        <div>
                            <span style="font-size:10px;display: inline-block;line-height: 35px; height: 35px;">维护单位<!--<SIAT_zh_CN original="Powered by">维护单位</SIAT_zh_CN>-->&nbsp;</span>
