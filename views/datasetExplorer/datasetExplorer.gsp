...
<head>
    ...
    <title>数据集管理器<!--<SIAT_zh_CN original="Dataset Explorer">数据集管理器</SIAT_zh_CN>--></title>
...
<h3 id="test">载入...<!--<SIAT_zh_CN original="Loading">载入</SIAT_zh_CN>--></h3>
<tmpl:/RWG/boxSearch hide="true"/>
<tmpl:/RWG/filterBrowser/>
<div id="sidebartoggle">&nbsp;</div>

<div id="noAnalyzeResults" style="display: none;">未发现主题(subject-level)级别的结果.<!--<SIAT_zh_CN original="No subject-level results found">未发现主题级别的结果</SIAT_zh_CN>--><br/>
<g:if test="${!grailsApplication.config.ui.tabs.browse.hide}">
    <g:link controller="RWG" action="index">切换到浏览视图<!--<SIAT_zh_CN original="Switch to Browse view">切换到浏览视图</SIAT_zh_CN>--></g:link>
</g:if>
</div>
...
<div id="saveReportDialog" style="display:none;font: 11px arial,tahoma,helvetica,sans-serif;font-weight:normal;">
    <br/>
    报告名称<!--<SIAT_zh_CN original="Report Name">报告名称</SIAT_zh_CN>--> : <input id='txtReportName' type='text' title="报告名称"/><!--<SIAT_zh_CN original="Report Name">报告名称</SIAT_zh_CN>--> <br/>
    是该报告公开<!--<SIAT_zh_CN original="Make Report Public">是该报告公开</SIAT_zh_CN>--> : <input id='chkReportPublic' type='checkbox' value='Y' title="是该报告公开"/><!--<SIAT_zh_CN original="Make Report Public">是该报告公开</SIAT_zh_CN>--><br/><br/>
    ...
    <input type="button"
           ...
           value="创建报告"/><!--<SIAT_zh_CN original="Create Report">创建报告</SIAT_zh_CN>-->
</div>
...
<div id="saveSubsetsDialog" style="display:none;font: 11px arial,tahoma,helvetica,sans-serif;font-weight:normal;">
    <form id="saveSubsetForm">
        <br/>
        <em>*</em> 描述<!--<SIAT_zh_CN original="Description">描述</SIAT_zh_CN>--> : <input id='txtSubsetDescription' type='text' name='txtSubsetDescription'
                                        title="子集描述"/><!--<SIAT_zh_CN original="Subset Description">子集描述</SIAT_zh_CN>-->
        <br/>
        <em>*</em> 使该子集公开<!--<SIAT_zh_CN original="Make Subset Public">使该子集公开</SIAT_zh_CN>--> : <input id='chkSubsetPublic' type='checkbox' value='Y' title="公开子集"/><!--<SIAT_zh_CN original="Subset Public">公开子集</SIAT_zh_CN>-->
        <br/>
        <br/>
        <input class="submit" type="submit" value="保存子集"/><!--<SIAT_zh_CN original="Save Subsets">保存子集</SIAT_zh_CN>-->
    </form>
</div>
