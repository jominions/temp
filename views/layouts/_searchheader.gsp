                                            ...
                                            <td style="white-space:nowrap;" nowrap>
                                                <g:form name="form" controller="search" action="search">
                                                    ...
                                                    <button id="search-button" type="button" onclick="searchOnClick();"
                                                            style="vertical-align:middle;">搜索<!--<SIAT_zh_CN original="Search">搜索</SIAT_zh_CN>--></button>
                                                    &nbsp;
                                                </g:form>
                                            </td>
                                            <td style="vertical-align:middle">
                                                <div id="linkbuttons-div">
                                                    <a id="browse-link" class="tiny"
                                                       ...
                                                       return false;">
                                                        浏览<!--<SIAT_zh_CN original="browse">浏览</SIAT_zh_CN>-->
                                                    </a>
                                                    <br/>
                                                    <a id="savedfilters-link" class="tiny"
                                                       style="text-decoration:underline;color:blue;font-size:11px;"
                                                       href="${createLink(controller: 'customFilter', action: 'list')}">
                                                        <nobr>已保存的过滤器<!--<SIAT_zh_CN original="saved filters">已保存的过滤器</SIAT_zh_CN>--></nobr>
                                                    </a>
                                                </div>
                                            </td>
                                        </tr>
            ...
            <td style="vertical-align: middle;">
                <g:form name="form" controller="search" action="search">
                    ...
                    <button id="search-button" style="vertical-align: middle;" type="button"
                            onclick="searchOnClick();">搜索<!--<SIAT_zh_CN original="Search">搜索</SIAT_zh_CN>--></button>
                </g:form>
            </td>
            <td style="vertical-align: middle; white-space: nowrap;">
                <div id="linkbuttons-div">
                    ...
                    <a id="savedfilters-link" class="tiny" style="text-decoration:underline;color:blue;font-size:11px;"
                       href="${createLink(controller: 'customFilter', action: 'list')}">
                        已保存的过滤器<!--<SIAT_zh_CN original="saved filters">已保存的过滤器</SIAT_zh_CN>-->
                    </a>
                </div>
            </td>
