...
<head>
    ...
    <title>样本管理器<!--<SIAT_zh_CN original="Sample Explorer">样本管理器</SIAT_zh_CN>--> :: ${grailsApplication.config.com.recomdata.appTitle}</title>
...
<h3 id="test">正在载入....<!--<SIAT_zh_CN original="Loading">正在载入</SIAT_zh_CN>--></h3>
