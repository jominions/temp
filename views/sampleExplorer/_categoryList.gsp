...
<TBODY>
    ...
    <tr>
        <td>
            <a href="#"
               onClick="toggleMoreResults(document.getElementById('tbodyMoreLink${termName}'), document.getElementById('tbodyLessLink${termName}'), document.getElementById('tbodyHiddenResults${termName}'))">少于<!--<SIAT_zh_CN original="Less">少于</SIAT_zh_CN>--> [-]</a>
        </td>
    </tr>
    </TBODY>
</table>