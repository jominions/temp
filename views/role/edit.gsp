...
<head>
    ...
    <title>编辑角色<!--<SIAT_zh_CN original="Edit Role">编辑角色</SIAT_zh_CN>--></title>
</head>

<body>
<div class="body">
    <h1>编辑角色<!--<SIAT_zh_CN original="Edit Role">编辑角色</SIAT_zh_CN>--></h1>
    ...
    <g:form>
        ...
        <div class="dialog">
            <table>
                ...
                <tr class="prop">
                    <td valign="top" class="name"><label for="people">包含用户<!--<SIAT_zh_CN original="People">包含用户</SIAT_zh_CN>-->:</label></td>
        ...
        <div class="buttons">
            <span class="button"><g:actionSubmit class="save"
                    action="Update" value="更新"/><!--<SIAT_zh_CN original="Update">更新</SIAT_zh_CN>--></span>
