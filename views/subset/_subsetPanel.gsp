<div style="width:100%;height:100%;background-color:white">
    ...
    <table class="subsettable" border="0px" style="margin:10px">
        ...
        <tr>
            <td align="center">
                <span style="text-decoration: underline;font-size:1.25em;font-weight:bold;">子集1<!--<SIAT_zh_CN original="Subset 1">子数据集1</SIAT_zh_CN>--></span>
            </td>
            ...
            <td align="center">
                <span style="text-decoration: underline;font-size:1.25em;font-weight:bold;">子集2<!--<SIAT_zh_CN original="Subset 2">子数据集2</SIAT_zh_CN>--></span>
            </td>
        </tr>
            ...
            <tr id="qcr${currentGroup}">
                <td align="right">
                    <g:if test="${currentGroup > 1}">
                        且<!--<SIAT_zh_CN original="AND">且</SIAT_zh_CN>-->&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                    </g:if>
                    <button id="btnPanelTimingGroup1_${currentGroup}" style="font:9pt tahoma;display:none;"
                            onclick="timingGroup(this, '1', '${currentGroup}')">独立<!--<SIAT_zh_CN original="Independent">独立</SIAT_zh_CN>--></button>
                    <button id="btnExcludeGroup1_${currentGroup}" style="font:9pt tahoma;"
                            onclick="excludeGroup(this, '1', '${currentGroup}')">排除<!--<SIAT_zh_CN original="Exclude">排除</SIAT_zh_CN>--></button>
                ...
                <td align="right">
                    ...
                    <button id="btnPanelTimingGroup2_${currentGroup}" style="font:9pt tahoma;display:none;"
                            onclick="timingGroup(this, '2', '${currentGroup}')">单独的<!--<SIAT_zh_CN original="Independent">单独的</SIAT_zh_CN>--></button>
                    <button id="btnExcludeGroup2_${currentGroup}" style="font:9pt tahoma;"
                            onclick="excludeGroup(this, '2', '${currentGroup}')">排除<!--<SIAT_zh_CN original="Exclude">排除</SIAT_zh_CN>--></button>
    ...
    function toggleQueryTimingButtons(dropdownValue) {
        for (var i = 1; i <= 20; i++) {
            ...
            if (dropdownValue == "SAMEEVENT") {
                ...
                jQuery(currentButton1).text("独立")//<SIAT_zh_CN original="Independent">独立</SIAT_zh_CN>
                jQuery(currentButton2).text("独立")//<SIAT_zh_CN original="Independent">独立</SIAT_zh_CN>
