...
<script type="text/javascript" charset="utf-8">
    ...
    jQuery(document).ready(function () {
        ...
        jQuery("#createAssayOverlay").on('click', '#cancelassaybutton', function () {
            if (!confirm('确认取消更改?')) {//<SIAT_zh_CN original="Are you sure you want to cancel your changes?">确认取消更改?</SIAT_zh_CN>
                return false;
            }
            ...
            jQuery.ajax({
                ...
                success: function (response) {
                    if (response.errors != undefined) {
                        ...
                        jQuery('#saveassaybutton').removeClass('buttonloading').text('保存');//<SIAT_zh_CN original="Save">保存</SIAT_zh_CN>
                    } else {
        ...
        jQuery("#createFolderOverlay").on('click', '#savefolderbutton', function () {
            ...
            jQuery.ajax({
                ...
                error: function (xhr) {
                    alert(xhr);
                    jQuery('#savefolderbutton').removeClass('buttonloading').text('保存');//<SIAT_zh_CN original="Save">保存</SIAT_zh_CN>
                },
                type: 'POST'
            });
        });
            ...
            jQuery.ajax({
                ...
                success: function (response) {
                    if (response.errors != undefined) {
                        ...
                        jQuery('#savestudybutton').removeClass('buttonloading').text('保存');//<SIAT_zh_CN original="Save">保存</SIAT_zh_CN>
                    } else {
                        //updateFolder(response.parentId);
                        jQuery('#createStudyOverlay').fadeOut();
                        //showDetailDialog(response.id);
            ...
            jQuery.ajax({
                ...
                success: function (response) {
                    if (response.errors != undefined) {
                        ...
                        jQuery('#saveprogrambutton').removeClass('buttonloading').text('保存');//<SIAT_zh_CN original="Save">保存</SIAT_zh_CN>
                    } else {
                        showSearchResults();
                        jQuery('#createProgramOverlay').fadeOut();
                        showDetailDialog(response.id);
            ...
            jQuery.ajax({
                ...
                success: function (response) {
                    if (response.errors != undefined) {
                        ...
                        jQuery('#saveanalysisbutton').removeClass('buttonloading').text('保存');//<SIAT_zh_CN original="Save">保存</SIAT_zh_CN>
                    } else {
                        //updateFolder(response.parentId);
                        jQuery('#createAnalysisOverlay').fadeOut();
                        //showDetailDialog(response.id);
    ...
    function updateExportCount() {
        ...
        if (checkboxes.size() == 0) {
            ...
            jQuery('#exportbutton').removeClass('disabled').text('导出所选中的文件 (' + checkboxes.size() + ')');//<SIAT_zh_CN original="Export selected files">导出所选中的文件</SIAT_zh_CN>
        }
    }
...
<div id="sidebar" style="width:320px; border-right:5px solid;border-color:#EDEEF6">
    ...
    <div id="program-explorer">
        <div id="title-program-div" class="ui-widget-header boxtitle">
            <h2 style="float:left" class="title">项目管理器<!--<SIAT_zh_CN original="Program Explorer">项目管理器</SIAT_zh_CN>--></h2>
        </div>
...
<div id="divPlotOptions" style="width:300px; display: none;">
    <table class="columndetail">
        <tr>
            <td class="columnname">SNP注释源<!--<SIAT_zh_CN original="SNP Annotation Source">SNP注释源</SIAT_zh_CN>--></td>
            <td>
                <select id="plotSnpSource" style="width: 220px">
                    <option value="19">人类基因19号<!--<SIAT_zh_CN original="Human Genome 19">人类基因19号</SIAT_zh_CN>--></option>
                    <option value="18">人类基因18号<!--<SIAT_zh_CN original="Human Genome 19">人类基因18号</SIAT_zh_CN>--></option>
                </select>
            </td>
        </tr>
        <%--<tr>
        ...
        <tr>
            <td class="columnname"> P值切断(P-value cutoff):<!--<SIAT_zh_CN original="P-value Cutoff"> P值切断(P-value cutoff)</SIAT_zh_CN>--></td>
            <td>
...
<div style="display:none">
    <div id="xtHolder">
        <div id="xtTopbar">
            <p>交叉实验分析<!--<SIAT_zh_CN original="Cross Trial Analysis">交叉实验分析</SIAT_zh_CN>--></p>
            <ul id="xtMenu">
                <li>总结<!--<SIAT_zh_CN original="Summary">总结</SIAT_zh_CN>--></li>
                <li>热图(Heatmap)<!--<SIAT_zh_CN original="Heatmap">热图(Heatmap)</SIAT_zh_CN>--></li>
                <li>箱线图(Boxplot)<!--<SIAT_zh_CN original="Boxplot">箱线图(Boxplot)</SIAT_zh_CN>--></li>
            </ul>

            <p>关闭<!--<SIAT_zh_CN original="close">关闭</SIAT_zh_CN>--></p>
        </div>
