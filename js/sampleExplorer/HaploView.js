...
function showHaploviewGeneSelection()
{
	...
	var win = new Ext.Window({
		...
		title: '选择 Haploview-Gene',//<SIAT_zh_CN original="Haploview-Gene Selection">选择 Haploview-Gene</SIAT_zh_CN>
		layout:'fit',
		width:250,
		height:250,
		closable: false,
		...
		buttons: [
		          ...
		          tools:[{
		        	  id:'help',
		        	  qtip:'点击取得上下文相关的帮助', //<SIAT_zh_CN original="Click for context sensitive help">点击取得上下文相关的帮助</SIAT_zh_CN>
