...
function loadDataSetGrid()
{
    ...
    if(GLOBAL.explorerType == "sampleExplorer")
    {
        ...
        GLOBAL.resultGridPanel = new Ext.grid.GridPanel({
            ...
            tbar:['->',
                {
                    text:'样本联系信息',//<SIAT_zh_CN original="Sample Contact Information">样本联系信息</SIAT_zh_CN>
                    tooltip:'样本联系信息',//<SIAT_zh_CN original="Sample Contact Information">样本联系信息</SIAT_zh_CN>
                    handler : function()
                    {
                ...
                {
                    text:'全部折叠',//<SIAT_zh_CN original="Collapse All">全部折叠</SIAT_zh_CN>
                    tooltip:'全部折叠',//<SIAT_zh_CN original="Collapse All">全部折叠</SIAT_zh_CN>
                    handler : function()
                    {
                ...
                {
                    text:'全部展开',//<SIAT_zh_CN original="Expand All">全部展开</SIAT_zh_CN>
                    tooltip:'全部展开',//<SIAT_zh_CN original="Expand All">全部展开</SIAT_zh_CN>
                    handler : function()
                    {
    ...
    else
    {
        ...
        GLOBAL.resultGridPanel = new Ext.grid.GridPanel({
            ...
            enableDragDrop : true,
            ddGroup : 'resultsGridPanel-dd',
            ddText : '放置于此行',//<SIAT_zh_CN original="Place this row.">放置于此行</SIAT_zh_CN>
            style: 'margin: 30px auto',
            store: listingGroupedStore,
            colModel: dataSetColModel,
            stripeRows: true,
...
function renderDSELink(val)
{
    if(val)
    {
        return val + '&nbsp;<a href="' + pageInfo.basePath + '/datasetExplorer/index?DataSetName=' + val + '" target="_blank" title="点击检视 ' + val + ' 在数据集管理器中!"><img src="' + pageInfo.basePath + '/images/linkext7.gif"></a>';//<SIAT_zh_CN original="Click to view">点击检视</SIAT_zh_CN><SIAT_zh_CN original="in Dataset Explorer">在数据集管理器中</SIAT_zh_CN>
    }
}
...
function addTabbedSubset()
{
    ...
    var newTab = GLOBAL.tabs.add({
        ...
        title: '子集 ' + panelNumber,//<SIAT_zh_CN original="Subset">子集</SIAT_zh_CN>
...
function addSubset(panelNumber)
{
    ...
    var subsetGrid = new Ext.grid.GridPanel({
        ...
        tbar:['->',
            {
                text:'清除子集',//<SIAT_zh_CN original="Clear Subset">清除子集</SIAT_zh_CN>
                tooltip:'清除子集',//<SIAT_zh_CN original="Clear Subset">清除子集</SIAT_zh_CN>
                handler : function()
                {
                    /*
...
function showBioBankResults(dataStoreID)
{
    ...
    ({
        ...
        title: '样本详细信息',//<SIAT_zh_CN original="Detailed Sample Information">样本详细信息</SIAT_zh_CN>
        autoScroll:true,
        closable: true,
        buttons: [],
        resizable: true,
...
function showNewsUpdateDetail(newsid)
{
    ...
    ({
        ...
        title: '最近更新',//<SIAT_zh_CN original="Recent Update">最近更新</SIAT_zh_CN>
        closable: true,
        buttons: [],
        resizable: true,
        autoLoad:
...
function gatherSampleContactInformation()
{
    ...
    if(jsonDataToPost.SearchJSON.Records.length <= 0) {
        alert("您未选择任何样本, 请先选择样本<.");//<SIAT_zh_CN original="You have not selected any sample. Please select your sample(s) first">您未选择任何样本, 请先选择样本</SIAT_zh_CN>
        return;
    }
    ...
    ({
        id: 'bioBankResultsWindow',
        title: '样本联系信息',//<SIAT_zh_CN original="Sample Contact Information">样本联系信息</SIAT_zh_CN>
        autoScroll:true,
        closable: true,
        buttons: [],
        resizable: true,
