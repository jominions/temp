  ...
  function pleaseWait() {
   ...
   function createUserSearchBox(ajaxurl, boxwidth, ivalue){
    ...
    var search = new Recom.rc.ComboBox({
        ...
        displayField:'title',
        typeAhead: false,
        loadingText: '搜索中...',//<SIAT_zh_CN original="Searching">搜索中</SIAT_zh_CN>
        width: boxwidth,
        //listWidth: 430,
        listHeight:500,
        valueField:'uid',
...
Recom.rc.serializeFormElements = function(elements, form /* jquery el or undef */) {
    ...
    elements.forEach(function(id) {
        ...
        if (!jQueryEl.length) {
            ...
            if (!jQueryEl.length) {
                console.error('无法找到此id或名称对应的元素 \'' +//<SIAT_zh_CN original="Could not find element with id or name">无法找到此id或名称对应的元素</SIAT_zh_CN>
                        id + '\' 形式 ' + form);//<SIAT_zh_CN original="in form">形式</SIAT_zh_CN>
            }
        }
