...
ColReorder = function( oDTSettings, oOpts )
{
	...
	{
		alert( "警告: ColRecorder必须用关键字 'new' 初始化" );//<SIAT_zh_CN original="Warning: ColReorder must be initialised with the keyword 'new'">警告: ColRecorder必须用关键字 'new' 初始化</SIAT_zh_CN>
	}
...
{
	alert( "警告: ColRecorder 需要Datables 1.9.3或更高版本 - www.datatables.net/download");//<SIAT_zh_CN original="Warning: ColReorder requires DataTables 1.9.3 or greater - www.datatables.net/download">警告: ColRecorder 需要Datables 1.9.3或更高版本 - www.datatables.net/download</SIAT_zh_CN>
}
