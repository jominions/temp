...
org.systemsbiology.visualization.DiscreteColorRange = Class.create({
    ...
    initialize: function(maxColors,dataRange,options) {
        ...
        if(maxColors>=1 && dataRange) {
            ...
            throw('org.systemsbiology.visualization.DiscreteColorRange 实例化错误, 为提供需要的参数');//<SIAT_zh_CN original="Error in org.systemsbiology.visualization.DiscreteColorRange instantiation. required parameters not provided">org.systemsbiology.visualization.DiscreteColorRange 实例化错误, 为提供需要的参数</SIAT_zh_CN>
        }
