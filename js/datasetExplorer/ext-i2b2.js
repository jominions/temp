    ...
    for (var i = 0; i < size2; i++) {
                ...
                GLOBAL.IsAdmin) //if im an admin or there is an access level other than locked leave node unlocked
        {
            ...
            child.on('beforeload', function (node) {
                alert("该节点限制访问。请联系管理员以获得访问权限。");//<SIAT_zh_CN original="Access to this node has been restricted. Please contact your administrator for access.">该节点限制访问。请联系管理员以获得访问权限。</SIAT_zh_CN>
                return false
            });
        }
    }
