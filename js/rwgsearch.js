//translate function for rwgsearch CHEN Zhuo 150325
//<SIAT_zh_CN original="translate function for rwgsearch CHEN Zhuo 150325">function translateRwgZhCN(engText)</SIAT_zh_CN>
function translateRwgZhCN(engText){
	 var translateText = engText;
    ...
    switch(translateText){
    	...
    	case 'Bacterial and Fungal Diseases':{
            translateText='细菌和真菌引起的疾病';
        }break;
        case 'Behaviors and Mental Disorders':{
            translateText='行为与心理障碍';
        }break;
        case 'Blood and Lymph Conditions':{
            translateText='血液和淋巴的条件';
        }break;
        case 'Cancers and Other Neoplasms':{
            translateText='癌症和其他肿瘤';
        }break;
        case 'Digestive System Diseases':{
            translateText='消化系统疾病';
        }break;
        case 'Diseases and Abnormalities at or before Birth':{
            translateText='在出生前或出生时的疾病和异常';
        }break;
        case 'Ear Nose and Throat Diseases':{
            translateText='耳鼻咽喉疾病';
        }break;
        case 'Eye Diseases':{
            translateText='眼科疾病';
        }break;
        case 'Gland and Hormone Related Diseases':{
            translateText='腺体和激素相关疾病';
        }break;
        case 'Heart and Blood Diseases':{
            translateText='心脏和血管疾病';
        }break;
        case 'Immune System Diseases':{
            translateText='免疫系统疾病';
        }break;
        case 'Mouth and Tooth Diseases':{
            translateText='口腔和牙齿的疾病';
        }break;
        case 'Muscle Bone and Cartilage Diseases':{
            translateText='肌骨和软骨的疾病';
        }break;
        case 'Nervous System Diseases':{
            translateText='神经系统疾病';
        }break;
        case 'Nutritional and Metabolic Diseases':{
            translateText='营养和代谢性疾病';
        }break;
        ...
        case 'Respiratory Tract (Lung and Bronchial) Diseases':{
            translateText='呼吸道（肺和支气管）疾病';
        }break;
        case 'Skin and Connective Tissue Diseases':{
            translateText='皮肤和结缔组织疾病';
        }break;
        case 'Substance Related Disorders':{
            translateText='物质相关性障碍';
        }break;
        case 'Symptoms and General Pathology':{
            translateText='症状和普通病理学';
        }break;
        case 'Urinary Tract Sexual Organs and Pregnancy Conditions':{
            translateText='泌尿生殖器和妊娠的条件';
        }break;
        case 'Viral Diseases':{
            translateText='病毒性疾病';
        }break;
        case 'Wounds and Injuries':{
            translateText='创伤和损伤';
        }break;
        case 'Development candidate':{
            translateText='发展的候选人';
        }break;
        case 'Hit finding':{
            translateText='Hit finding';
        }break;
        case 'Lead optimization':{
            translateText='引导优化';
        }break;
        case 'Life cycle management':{
            translateText='生命周期管理';
        }break;
        case 'Phase 0':{
            translateText='第0阶段';
        }break;
        ...
        case 'Phase III':{
            translateText='第III阶段';
        }break;
        case 'Post market approval':{
            translateText='Post market approval';
        }break;
        case 'Preclinical':{
            translateText='潜伏期的';
        }break;
        ...
        case 'Target identification / validation':{
            translateText='目标识别/验证';
        }break;
        case 'Demonstrate clinical benefit Proof of Concept in clinic':{
            translateText='展示概念在门诊临床获益证明';
        }break;
        // case 'Demonstrate mechanistic Proof of Concept in clinic':{
        //     translateText='Demonstrate mechanistic Proof of Concept in clinic';
        // }break;
        case 'Discover biomarkers':{
            translateText='发现生物标志物';
        }break;
        case 'Discover targets/biological contexts':{
            translateText='发现目标/生物环境';
        }break;
        case 'Mode Of Action analysis':{
            translateText='动作分析模式';
        }break;
        ...
        case 'Select lead or development candidates':{
            translateText='选择领导或发展候选人';
        }break;
        case 'Interventional':{
            translateText='介入';
        }break;
        ...
        case 'Efficacy biomarker':{
            translateText='有效的生物标志物';
        }break;
        case 'PD biomarker':{
            translateText='PD 生物标记物';
        }break;
        case 'Patient selection biomarker':{
            translateText='患者选择的生物标志物';
        }break;
        case 'Commercial':{
            translateText='商业的';
        }break;
        ...
        case 'Copy number variation profiling':{
            translateText='拷贝数变异分析';
        }break;
        ...
        case 'Metabolite profiling':{
            translateText='代谢产物分析';
        }break;
        // case 'NA':{
        //     translateText='NA';
        // }break;
        case 'Protein expression profiling':{
            translateText='蛋白质表达谱';
        }break;
        case 'Protein identification':{
            translateText='蛋白质鉴定';
        }break;
        case 'Protein-protein interaction determination':{
            translateText='蛋白质相互作用的测定';
        }break;
        case 'SNP Analysis':{
            translateText='SNP 分析';
        }break;
        case 'Transcription Profiling':{
            translateText='转录分析';
        }break;
        case 'DNA Microarray':{
            translateText='DNA 微阵列';
        }break;
        // case 'ELISA':{
        //     translateText='ELISA';
        // }break;
        ...
        case 'Hematoxylin and Eosin Staining':{
            translateText='Hematoxylin and Eosin 染色法';
        }break;
        case 'Immunohistochemistry':{
            translateText='免疫组织化学';
        }break;
        ...
        case 'NMR spectroscopy':{
            translateText='核磁共振光谱';
        }break;
        case 'No technology required ':{
            translateText='没有技术要求';
        }break;
        case 'Nucleotide sequencing':{
            translateText='核苷酸序列分析';
        }break;
        case 'Protein microarray':{
            translateText='蛋白质微阵列';
        }break;
        case 'Real time PCR':{
            translateText='实时定量聚合酶链反应';
        }break;
        case 'Copy number variation profiling':{
            translateText='拷贝数变异分析';
        }break;
...
///////////original code text below CHEN Zhuo //////////////////
////////////////////////////////////////////////////////////////////
// Globals
...
// will still fire but is stopped immediately); and set this flag back to true at the e·nd of the event so it can be triggered again.  
...
//	jQuery("#search-categories").append(jQuery("<option></option>").attr("value", "ALL").text("All").attr('id', 'allCategory'));
		jQuery("#search-categories").append(jQuery("<option></option>").attr("value", "ALL").text("全部").attr('id', 'allCategory'));
	...
	jQuery.getJSON(getCategoriesURL, function(json) {
		for (var i=0; i<json.length; i++)	{
			...
			catText = translateRwgZhCN(catText);
		...
		jQuery("#allCategory").after(jQuery("<option></option>").attr("value", "text").text("任意文本"));//<SIAT_zh_CN original="Free Text">任意文本</SIAT_zh_CN>
	...
	jQuery.getJSON(getFilterCategoriesURL, function(json) {
		for (var i=0; i<json.length; i++)	{
			...
			for (var j=0; j < choices.length; j++) {
				...
				//<SIAT_zh_CN original="editCode">陈卓修改</SIAT_zh_CN>
				var translateChoiceName = translateRwgZhCN(choice.name);
				var newItem = jQuery("<div></div>").addClass("filteritem").attr("name", category.category).attr("id", choice.uid).text(translateChoiceName);//(choice.name);
...
function displayResultsNumber(){
	if(resultNumber!=""){
		...
		jQuery('#metadata-viewer').empty();
		var htmlResults="<div style='margin: 10px;padding: 10px;'><h3 class='rdc-h3'>按类型的搜索结果</h3>";//<SIAT_zh_CN original="Search results by type">按类型的搜索结果</SIAT_zh_CN>
		htmlResults+="<table class='details-table'>";
		htmlResults+="<thead><tr><th class='columnheader'>物体</th><th class='columnheader'>结果数量</th></tr></thead>";//<SIAT_zh_CN original="Number of results">结果数量</SIAT_zh_CN>//<SIAT_zh_CN original="Object">物体</SIAT_zh_CN>
		htmlResults+="<tr class='details-row odd'><td class='columnname'>项目</td><td class='columnvalue'>"+jsonNumbers.PROGRAM+"</td></tr>";//<SIAT_zh_CN original="Programs">项目</SIAT_zh_CN>
		htmlResults+="<tr class='details-row odd'><td class='columnname'>案例(Study)</td><td class='columnvalue'>"+jsonNumbers.STUDY+"</td></tr>";//<SIAT_zh_CN original="Study">案例(Study)</SIAT_zh_CN>
		htmlResults+="<tr class='details-row odd'><td class='columnname'>测定</td><td class='columnvalue'>"+jsonNumbers.ASSAY+"</td></tr>";//<SIAT_zh_CN original="Assays">测定</SIAT_zh_CN>
		htmlResults+="<tr class='details-row odd'><td class='columnname'>分析</td><td class='columnvalue'>"+jsonNumbers.ANALYSIS+"</td></tr>";//<SIAT_zh_CN original="Analyses">分析</SIAT_zh_CN>
		htmlResults+="<tr class='details-row odd'><td class='columnname'>文件夹</td><td class='columnvalue'>"+jsonNumbers.FOLDER+"</td></tr>";//<SIAT_zh_CN original="Folders">文件夹</SIAT_zh_CN>
